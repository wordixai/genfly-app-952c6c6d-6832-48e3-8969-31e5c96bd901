          ...
          <div className="flex w-full flex-col gap-12 md:gap-[70px] md:max-w-[1024px] lg:flex-1 lg:max-w-[1170px]">
            <div className="flex flex-col items-center gap-[70px] w-full">
              <div className="flex flex-col items-center gap-4 w-full text-center">
                <h3 className="text-4xl md:text-5xl section-title text-foreground mb-4">
                  Design and training of Macaron agent
                </h3>
                <p className="text-lg md:text-xl text-secondary max-w-[1020px]">
              ...
              <div className="flex flex-col items-center gap-9 w-full">
                <div className="relative overflow-visible">
                  <img 
                    ...
                    src="https://macaron.im/_next/image?url=%2Fassets%2Fimage%2Frl-for-agentic-memory.png&w=3840&q=75&dpl=dpl_GQQLtm6CXRU3K1iKL9EoXpSkokM1"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="w-full flex flex-col gap-6 md:flex-row md:gap-3.5 lg:flex-row lg:gap-3.5">
                <div className="flex-1">
                  <div className="flex flex-col items-center justify-start gap-2.5 w-[370px] md:gap-0">
                    <div className="text-center">
                      <span className="inline-block tabular-nums text-[40px] md:text-[58px] lg:text-[72px] font-light text-foreground font-sans">
                        96%
                      </span>
                    </div>
                    <p className="text-center text-foreground/50 leading-relaxed text-sm md:text-lg">GAIA Level 1</p>
                  </div>
                </div>
                ...
                <div className="flex-1">
                  <div className="flex flex-col items-center justify-start gap-2.5 w-[370px] md:gap-0">
                    ...
                    <p className="text-center text-foreground/50 leading-relaxed text-sm md:text-lg">Base Model for RL</p>
                  </div>
                </div>
                ...
                <div className="flex-1">
                  <div className="flex flex-col items-center justify-start gap-2.5 w-[370px] md:gap-0">
                    ...
                    <p className="text-center text-foreground/50 leading-relaxed text-sm md:text-lg">Cases Generated in 36min</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2.5 md:flex-row md:gap-2.5 xl:flex-row xl:gap-2.5 items-center justify-center w-min relative">
                <div className="w-[290px] h-auto">
                  <Button className="bg-macaron-gradient noise-background text-white border border-white/70 shadow-[inset_0px_0px_17px_0px_rgba(255,255,255,0.25)] h-14 rounded-full px-10 text-base relative overflow-visible z-20 w-full">
                    <span className="relative z-20">Read technical blog</span>
                  </Button>
                </div>
                <div className="w-[290px] h-auto">
                  <Button 
