    ...
    <section className="w-full py-16 md:py-24 bg-[#f9f7f2]">
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-5xl section-title text-foreground mb-4">第一手印象</h2>
          <p className="text-lg md:text-xl text-secondary max-w-2xl mx-auto">与我们 AI 合作伙伴合作的思想家和创作者的真实反馈</p>
        </div>
        ...
        <div className="space-y-8 mb-16 relative px-6">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index}
              className={`relative max-w-[329px] md:max-w-[500px] lg:max-w-[621px] mb-8 ${
            ...
            >
              ...
              <div className={`absolute -bottom-4 w-12 h-12 bg-gradient-to-br from-gray-300 to-gray-400 rounded-full shadow-md border-2 border-white ${
                testimonial.side === 'left' ? 'left-0' : 'right-0'
              }`}>
                <img 
        ...
        <div className="text-center">
          <p className="text-2xl text-primary font-normal leading-snug">我们期待听到你与 Macaron 的故事。</p>
        </div>
      </div>
    </section>
  );
